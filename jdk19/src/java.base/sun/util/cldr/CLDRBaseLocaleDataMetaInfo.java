...
public class CLDRBaseLocaleDataMetaInfo implements LocaleDataMetaInfo {
    ...
    private static final Map<Locale, String[]> parentLocalesMap = HashMap.newHashMap(8);
    private static final Map<String, String> languageAliasMap = HashMap.newHashMap(204);
    ...
    private static class TZCanonicalIDMapHolder {
        static final Map<String, String> tzCanonicalIDMap = HashMap.newHashMap(460);
        static {
